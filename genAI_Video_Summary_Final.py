...
def download_youtube_video(youtube_url):
  ...
  return os.path.join(video_directory, download_files[0])
...
def turn_into_story(summary):
  prompt = f"Turn the follwoing video summary into a narrative story with characters, setting, conflict and resolution: \n\n{summary}"
  return model.invoke(prompt)

st.title("Bindu - YouTube/Uploaded Video Summarizer Using Groq LLM")
